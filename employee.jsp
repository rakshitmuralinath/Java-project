    ...
    <main class="container clear"> 
	  ...
	  <div style="clear:both"></div>
          ...
          <div class="one_third">
            ...
            <input type="text" name="employee_state" id="employee_state" value="<% out.print(Values.get("employee_state")); %>" size="22" required>	
          </div>
          <div class="one_third first">
            <label for="url">Country</label>
            <input type="text" name="employee_country" id="employee_country" value="<% out.print(Values.get("employee_country")); %>" size="22" required>	
          </div>
