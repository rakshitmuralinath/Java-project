  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <h2>Company Entry Form</h2>
        <form action="model/company.jsp" method="post">
		  <div id="empl_id">
		  ...
		  <div>
            ...
            <input type="text" name="company_phone" id="company_phone" value="<% out.print(Values.get("company_phone")); %>" size="22" style="width:300px;" required>
          </div>
		  <div id="company_status_row">
          ...
          <div>
            <input name="submit" type="submit" value="<% out.print(companyLabel); %> Company">
            &nbsp;
            <input name="reset" type="reset" value="Reset Form">
          </div>
		  <input type="hidden" name="act" value="Save" />
		  <input type="hidden" name="company_id" value="<% out.print(Values.get("company_id")); %>"/>
        </form>
        </div>
